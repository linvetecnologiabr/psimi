...
$extra_schema = [
	...
	'mainEntity' => [
		...
		['@type' => 'Question', 'name' => 'Quais são as especialidades oferecidas?', 'acceptedAnswer' => ['@type' => 'Answer', 'text' => 'As especialidades incluem terapia de casal, violência doméstica, depressão, luto, ansiedade, insegurança, baixa autoestima, dependência emocional, autoconhecimento e solidão e conexão social.']],
		['@type' => 'Question', 'name' => 'Onde são realizadas as sessões presenciais?', 'acceptedAnswer' => ['@type' => 'Answer', 'text' => 'As sessões presenciais são realizadas na R. Restinga, 113, Tatuapé, São Paulo, SP. Para mais detalhes, entre em contato pelo WhatsApp.']],
			...
			<div class="col-lg-12 col-sm-12 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s" data-wow-offset="0">
				<div class="cat_list">
					<ul>
						...
						<li><a href="<?= $base_url ?>/especialidades/mudanca-de-carreira"><img src="<?= $assets ?>/img/thumb10.jpg" alt="Autoconhecimento" loading="lazy"> Autoconhecimento</a></li>
						<li><a href="<?= $base_url ?>/especialidades/solidao-e-conexao-social"><img src="<?= $assets ?>/img/thumb-solidao.jpg" alt="Solidão e Conexão Social" loading="lazy"> Solidão e Conexão Social</a></li>
		...
		<div class="col-12 col-sm-10 col-lg-8">
			<div class="accordion faq-accordian" id="faqAccordion">
				...
				$faqs = [
					...
					['id' => 'Five', 'pergunta' => 'Quais são as especialidades oferecidas?', 'resposta' => 'As especialidades da Psicóloga Michely Ciardulo incluem terapia de casal, violência doméstica, depressão, luto, ansiedade, insegurança, baixa autoestima, dependência emocional, burnout, autoconhecimento e solidão e conexão social.', 'delay' => '0.4s'],
