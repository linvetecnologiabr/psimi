	...
	<script type="application/ld+json">
		{
			...
			"areaServed": [{
				...
				},
				{
					"@type": "Country",
					"name": "Brasil",
					"description": "Atendimento online para todo o Brasil"
				}
			],
			"hasOfferCatalog": {
				"@type": "OfferCatalog",
				...
				"itemListElement": [{
						...
						"itemOffered": {
							...
							"description": "Atendimento psicológico individual para adolescentes e adultos"
						}
					},
					{
						"@type": "Offer",
						"itemOffered": {
							...
							"description": "Atendimento psicológico para casais, fortalecimento de vínculos afetivos"
						}
					},
					{
						"@type": "Offer",
						"itemOffered": {
							"@type": "Service",
							"name": "Terapia Online",
							"description": "Atendimento psicológico online para todo o Brasil"
						}
					},
					{
						"@type": "Offer",
						"itemOffered": {
							...
							"description": "Atendimento presencial em São Paulo, SP"
						}
					}
				]
			}
